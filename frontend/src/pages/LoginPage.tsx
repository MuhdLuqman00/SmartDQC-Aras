    ...
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--bg)' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, position: 'relative' }}>
          <div style={{
            ...
            fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: 19, color: '#0F1B2F',
          ...
          <div>
            ...
            <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: 17 }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <div style={{ display: 'flex', gap: 22, flexWrap: 'wrap' }}>
            {[
              ...
              <div key={s.l}>
                <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: 22, color: 'var(--accent-soft)' }}>{s.v}</div>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40 }}>
        <div className="card" style={{ width: '100%', maxWidth: 400, padding: '40px 38px', animation: 'fadeUp 0.5s ease both' }}>
          ...
          <h2 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: 24, color: 'var(--text-primary)', marginBottom: 6 }}>
            {t('Sign In', 'Log Masuk')}
          </h2>
