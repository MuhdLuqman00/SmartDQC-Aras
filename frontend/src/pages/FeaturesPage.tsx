...
const FEATURES: Feat[] = [
  ...
  { n: 11, icon: <TrendingUp size={18} />, en: 'Predictive Risk Scoring', bm: 'Pemarkahan Risiko Ramalan',
    descEn: 'Child-level risk 0–100 + district forecast.', descBm: 'Risiko peringkat kanak-kanak 0–100 + ramalan daerah.',
    to: '/geo', api: '/risk/score · /risk/forecast' },
